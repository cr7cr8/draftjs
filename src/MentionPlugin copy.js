    ...
    externalES.getCurrentContent().getBlocksAsArray().forEach(function (block) {
      ...
      while ((matchArr = regx.exec(blockText)) !== null) {
        ...
        function createTag(tagName) {
          ...
          newContent = newContent.createEntity(`${tagName}_HEAD`, "IMMUTABLE", { mentionType: `${tagName}_HEAD` });
          ...
          newContent = newContent.createEntity(`${tagName}_BODY`, "IMMUTABLE", { mentionType: `${tagName}_BODY` });
