...
export default function ToolBlock(props) {
  ...
  return (
    ...
    <>
      ...
      {showColorPanel && <div style={{ position: "absolute", top: 0, width: "100%", overflow: "hidden" }}
      ...
      >
        ...
        {/* <SwitchBtn
          ...
          style={{ display: blockKey === startKey ? "block" : "none" }}
        //onChange={() => { setShowFontBar(pre => !pre); }} name="showFontBar" color="primary"
        /> */}
